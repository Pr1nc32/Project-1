		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>6/127 Rundle Mall,<span>Adelaide SA 5000.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:contact@studentprojects.live">info@SriLakshmiGrocery.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(08) 8203 9001</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
...
?>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© <?php echo date('Y'); ?> Sri Lakshmi Grocery. All rights reserved 
				<?php
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a  type="button" class="btn btn-warning">Click Here to Order</a>
      </div>
    </div>
  </div>
</div>
